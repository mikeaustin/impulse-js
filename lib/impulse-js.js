...
function compile(path, {mainFile: mainFile} = {mainFile: false}) {
  ...
  if (mainFile) {
    ...
    body.push("var __FILE__ = '" + process.argv[2] + "';");
    body.push("var __LINE__ = '" + 0 + "';");
    body.push("var impulse = require('./lib/runtime');");
    body.push("var Tuple = impulse.Tuple;");
    body.push("var Range = impulse.Range;");
    ...
    body.push("  console.log(e.name + ': [' + __FILE__ + ' : ' + __LINE__ + ']', e.message, stack);");
    body.push("};");
